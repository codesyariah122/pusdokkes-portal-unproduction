      ...
      <div class="trending-main">
        ...
        <div class="col-lg-4 col-sm-12">
          <div class="trand-right-single section-tittle">
            <b-button disable style="background :#00923f!important; color: #fff; font-size: 14px;" class="btn btn-block btn-md">
              pesan kapusdokkes
            </b-button>
          </div>
          ...
          <div class="trand-right-single section-tittle">
            <a style="background :#00923f!important; color: #fff; font-size: 14px;" class="btn btn-block btn-md" href="https://www.instagram.com/pusdokkespolri/?hl=id" target="_blank">
              <img
          ...
          <div  class="trand-right-single d-flex">
            <div class="trand-right-img" :style="`${$device.isMobile ? 'margin-left: -.3rem;' : ''}`">
              ...
              <div v-else class="row instagram__feed">
                <div v-if="feedIndex <= feeds.length" v-for="feedIndex in feedToShow" class="col-md-4 col-sm-4 mb-2 col-feed">
                ...
                <div v-if="feedIndex <= feeds.length || feeds.length > feedToShow" class="col-sm-12 col-md-12 mt-2">
                  <b-button @click="feedToShow += feeds.length" style="background :#00923f!important; color: #fff; font-size: 14px;" class="btn rounded-pill btn-block">
                    Lebih Banyak
                  </b-button>
                </div>
              </div>
