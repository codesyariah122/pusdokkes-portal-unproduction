<template>
	<div :style="`${$device.isMobile ? 'height: 300px; width: 100%;margin-bottom:2rem;' : 'height: 300px; width: 100%;'}`">
		<client-only>
			<div v-if="loading">
		...
		methods: {
			SetCoordinates(){
				...
				setTimeout(() => {
					...
					{
						id: 1,
						category_name: 'PPKC Carolus Jakarta',
						maps: [
						{
							id:1,
							title: "PPKC Carolus Office",
							lat: "-6.192373181219588",
							lng: "106.85215349999545",
							region: "Jakarta City",
							external_link: "https://www.google.com/maps/place/PPKC+CAROLUS/@-6.1935038,106.8521535,15z/data=!4m5!3m4!1s0x0:0x3517379d92f3f299!8m2!3d-6.1935018!4d106.8521586"
						}
						]
					}
					]
