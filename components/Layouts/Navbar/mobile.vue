  ...
  <div>
    ...
    <mdb-navbar-toggler class="mt-3 mb-2">
      ...
      <mdb-nav-item waves-fixed>
        <nuxt-link to="/pengaduan" tag="li" navLink > Pengaduan </nuxt-link>
      </mdb-nav-item>
</mdb-navbar-nav>
<!-- check user login -->
...
<div v-else>
  <mdb-row class="row justify-content-center">
    <mdb-col col="12" lg="12" xs="12" sm="12" class="mt-2">
      <nuxt-link 
      to="/auth/login"
      class="my__btn-secondary rounded btn btn-block btn-md shadow-none"
      size="md"
      >Login</nuxt-link>
    </mdb-col>        
  </mdb-row>
  ...
  export default {
    ...
    data() {
      return {
        ...
        hospitals: [
        { id: 1, name: "Rumkit Bhayangkara", link: "/faskes/rumkit" },
        { id: 2, name: "FKTP (Klinik) Polri", link: "/faskes/fktp" },
        ]
      };
    },
