<template>
  <div
    class=""
    style="padding-top: 100px; padding-left: 16px; padding-right: 16px"
  >
    <b><h3>Terms &amp; Conditions</h3></b>
    <p>
      ...
      intellectual property rights related to it, still belong to PPKC Carolus.
    </p>
    <p>
      PPKC Carolus is committed to ensuring that the app is as useful and
    ...
    <p>
      The E-Learning PPKC app stores and processes personal data that you have
      ...
      features and it could mean that the E-Learning PPKC app won’t work
      properly or at all.
    </p>
    <div>
      <p>
    ...
    <p>
      You should be aware that there are certain things that PPKC Carolus will
      ...
      provided by your mobile network provider, but PPKC Carolus cannot take
    ...
    <p>
      Along the same lines, PPKC Carolus cannot always take responsibility for
      ...
      Service, PPKC Carolus cannot accept responsibility.
    </p>
    <p>
      With respect to PPKC Carolus’s responsibility for your use of the app,
      ...
      available to you. PPKC Carolus accepts no liability for any loss, direct
    ...
    <p>
      ...
      keep using the app. PPKC Carolus does not promise that it will always
    ...
    <p>These terms and conditions are effective as of 2022-08-01</p>
    <p><strong>Contact Us</strong></p>
    <p>
      If you have any questions or suggestions about our Terms and Conditions,
      do not hesitate to contact us at elearning.ppkc@gmail.com.
    </p>
  </div>
</template>
